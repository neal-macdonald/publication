...
import random
from initializer_settings import *
...
class Conv(Layer):
  ...
  def __init__(self,
    ...
    if kernel_initializer._keras_api_names[0] == 'keras.initializers.NovelMethod':
        self.dilation_rate = conv_utils.normalize_tuple(
            1, rank, 'dilation_rate')
    else:
        self.dilation_rate = conv_utils.normalize_tuple(
  ...
  def build(self, input_shape):
    ...
    #     initial_value=w_init(shape=kernel_shape,
    #                          dtype=self.dtype,
    #                          trainable=True))
...
class NovelConv2D(Conv):
    def __init__(self,
               ...
               bias_constraint=None,
               **kwargs):
        super(NovelConv2D, self).__init__(
                    filters=filters,
